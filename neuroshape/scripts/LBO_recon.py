...
from scripts.fs_eigenmodes import calc_fs_eigenmodes
#%%
# =============================================================================
# #### Path sourcing ####
# =============================================================================

studyFolder = '/Volumes/Scratch/functional_integration_psychosis/study_data/'
study = 'microres'
task = 'go'
cohort = 'HC'
gradientFolder = f'{studyFolder}/{study}/gradients/{task}/{cohort}'
surfFolder = f'{studyFolder}/{study}/surfaces'
fsFolder = '/Volumes/Scratch/functional_integration_psychosis/preprocessed/{cohort}/FS'
emodesFolder = f'{studyFolder}/{study}/eigenmodes/{cohort}'

with open(f'{studyFolder}/{study}/subjects_{cohort}.txt', 'r') as fobj:
    subjects = fobj.read()
...
#%%
# =============================================================================
# #### Remap striatal projections to fsLR ####
# =============================================================================
...
#%%
# =============================================================================
# #### Extract surfaces and compute LBOs from Freesurfer pial ####
# =============================================================================

# running within python
surface_interest = 'pial'
hemispheres = ['lh', 'rh']
num_modes = 200
save_cut = True
save_mask = True
...
for subject in subjects:
    for hemisphere in hemispheres:
        print('Processing ' + subject + ' ' + hemisphere)
        surface_input_filename = f'{surfFolder}/{subject}.{hemisphere}.{surface_interest}'
        subject = subject
        fs_subjects_dir = fsFolder
        output_eval_filename = f'{emodesFolder}/{subject}.{hemisphere}.{surface_interest}.{num_modes}_evals.txt'
        output_emode_filename = f'{emodesFolder}/{subject}.{hemisphere}.{surface_interest}.{num_modes}_emodes.txt'
        
        # now run main surface eigenmode function
        calc_fs_eigenmodes(surface_input_filename, subject, fs_subjects_dir, output_eval_filename, output_emode_filename, save_cut, num_modes)
